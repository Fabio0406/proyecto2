...
const createPago = () => {
    ...
    Inertia.post('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/pagos', form.value, {
        onSuccess: () => {
...
const updatePago = () => {
    errors.value = {};  // Limpiar los errores
    Inertia.put(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/pagos/${form.value.id}`, form.value, {
        onSuccess: () => {
...
const deletePago = (id) => {
    if (confirm('¿Estás seguro de que deseas eliminar este pago?')) {
        Inertia.delete(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/pagos/${id}`);
    }
};
</script>
