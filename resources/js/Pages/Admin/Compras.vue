...
const createCompra = () => {
    errors.value = {};
    Inertia.post('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/compras', form.value, {
        onSuccess: () => {
            closeModal();
        },
        onError: (error) => {
...
const updateCompra = () => {
    errors.value = {};
    Inertia.put(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/compras/${form.value.id}`, form.value, {
        onSuccess: () => {
            closeModal();
        },
        onError: (error) => {
...
const deleteCompra = (id) => {
    if (confirm('¿Estás seguro de que deseas eliminar esta compra?')) {
        Inertia.delete(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/compras/${id}`);
    }
};

const goToDetalleCompra = (id) => {
    Inertia.get(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/detallecompras/${id}`);
};
</script>
