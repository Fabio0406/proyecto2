...
const agregarDetalleCompra = async () => {
    ...
    try {
        const response = await Inertia.post(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/detallecompras/${props.compras.id}`, {
...
const guardarTotal = async () => {
    try {
        await Inertia.put(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/compras/${props.compras.id}`, {
...
const volver = () => {
    Inertia.get('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/compras');
};
