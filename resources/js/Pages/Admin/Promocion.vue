...
const createPromocion = () => {
    errors.value = {};
    Inertia.post('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/promociones', form.value, {
        onSuccess: () => {
            closeModal();
        },
        onError: (error) => {
...
const updatePromocion = () => {
    errors.value = {};
    Inertia.put(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/promociones/${form.value.id}`, form.value, {
        onSuccess: () => {
            closeModal();
        },
        onError: (error) => {
...
const deletePromocion = (id) => {
    if (confirm('¿Estás seguro de que deseas eliminar esta promoción?')) {
        Inertia.delete(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/promociones/${id}`);
    }
};
</script>
