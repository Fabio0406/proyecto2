...
const createVenta = () => {
    ...
    Inertia.post('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/ventas', form.value, {
        onSuccess: () => {
...
const updateVenta = () => {
    errors.value = {};  // Limpiar los errores
    Inertia.put(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/ventas/${form.value.id}`, form.value, {
        onSuccess: () => {
...
const deleteVenta = (id) => {
    if (confirm('¿Estás seguro de que deseas eliminar esta venta?')) {
        Inertia.delete(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/ventas/${id}`, {
            onSuccess: () => {
...
const goToDetalleVenta = (id) => {
    Inertia.get(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/admin/detalleventas/${id}`);
};
</script>
