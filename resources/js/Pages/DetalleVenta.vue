...
const realizarPago = async () => {
    try {
        const response = Inertia.post('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/pagos/crear', {
            fecha_pago: new Date(),
        ...
        Inertia.get('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/pagos');
        if (response.success) {
            Inertia.get('https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/pagos');
        } else {
...
const agregarProductoVenta = async () => {
    ...
    try {
        const response = await axios.post(`https://mail.tecnoweb.org.bo/inf513/grupo23sa/proyecto2/public/ventas/cliente/${props.venta.id}/detalle`, {
